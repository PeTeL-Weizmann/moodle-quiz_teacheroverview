 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_teacheroverview_options extends mod_quiz_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        switch ($displayblocks) {
            ...
            case "full":
                ...
                break;
            default:
                $this->slotmarks = get_user_preferences('quiz_teacheroverview_slotmarks', $this->slotmarks);
        }
    ...
    public function update_user_preferences() {
        ...
        if (quiz_has_grades($this->quiz)) {
            set_user_preference('quiz_teacheroverview_slotmarks', $this->slotmarks);
        }
    }
