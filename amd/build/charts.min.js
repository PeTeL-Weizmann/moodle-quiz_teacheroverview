...
$('.quiz_teacheroverview_dashboard_block1 .clickable-grade').click(function(e){var filtergrade=$(this).attr('data-rel');var filtertitle=$(this).attr('data-title');$('#attempts tbody tr').not('.emptyrow').each(function(){$(this).show();$(this).toggle();});$('.teacheroverviewgrades a').each(function(){if($(this).attr('data-rel')==filtergrade){$(this).parent().parent().show();}});var filteredResults=str.get_string(filtertitle,'quiz_teacheroverview',e.target.innerHTML);filteredResults.done(function(val){$("#filtervalue").addClass('filtered').html(val);});$("HTML, BODY").animate({scrollTop:$("#attempts").offset().top},800);});}};});